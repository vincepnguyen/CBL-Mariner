...
Provides:       libdmmp = %{version}-%{release}
...
%changelog
* Tue Jul 27 2021 Thomas Crain <thcrain@microsoft.com> - 0.8.4-4
- Add compatibility provides for libdmmp package from base package
